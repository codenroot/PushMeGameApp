...
extension GameScene {
    ...
    func addPlayer() {
        ...
        player2 = SKSpriteNode(color: UIColor.blueColor(), size: CGSize(width: 50, height: 50))
    ...
    func addRow (type:RowType) {
        ...
        case.twoM:
            ...
            obst1.position = CGPoint(x: obst1.size.width / 2 + 100, y: obst1.position.y)
            obst2.position = CGPoint(x: self.size.width - obst2.size.width / 2 - 100, y: obst1.position.y)
        ...
        case.threeS:
            ...
            obst1.position = CGPoint(x: obst1.size.width / 2 + 100, y: obst1.position.y) // Left
            obst2.position = CGPoint(x: self.size.width - obst2.size.width / 2 - 100, y: obst1.position.y) // Right
